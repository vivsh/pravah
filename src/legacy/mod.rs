//! Compatibility-only workflow engine retained for applications using the original API.
//!
//! New workflows should use [`crate::graph`]. This module receives maintenance fixes but
