...
/// Read-only view into a running [`FlowRuntime`](crate::legacy::FlowRuntime).
/// Obtained via [`FlowRuntime::inspector`](crate::legacy::FlowRuntime::inspector).
...
impl<'a> FlowInspector<'a> {
    ...
    /// [`FlowRuntime::inject_message`](crate::legacy::FlowRuntime::inject_message) only when this returns `true`.
    ...
    /// injected at runtime via [`MemoryFactory`](crate::legacy::memory::MemoryFactory)
